...
public extension UIColor {
	static var cssColorList: [String: UIColor] = [
		...
		"iosorange": UIColor(red: 1.00, green: 0.58, blue: 0.00, alpha: 1.0), // 0xFF9500,
		"iosyellow": UIColor(red: 1.00, green: 0.80, blue: 0.00, alpha: 1.0), // 0xFFCC00,
		"iosgreen": UIColor(red: 0.30, green: 0.85, blue: 0.39, alpha: 1.0), // 0x4CD964,
		"iostealblue": UIColor(red: 0.35, green: 0.78, blue: 0.98, alpha: 1.0), // 0x5AC8FA,
		"iosblue": UIColor(red: 0.00, green: 0.48, blue: 1.00, alpha: 1.0), // 0x007AFF,
		"iospurple": UIColor(red: 0.35, green: 0.34, blue: 0.84, alpha: 1.0), // 0x5856D6,
		"iospink": UIColor(red: 1.00, green: 0.18, blue: 0.33, alpha: 1.0), // 0xFF2D55,
		// you can add more
	]

	static let cssNames: [String: CUnsignedLongLong] = [
		"aliceblue": 0xF0F8FF,
	...
	static func css(_ sstr: String, alpha: CGFloat = 1.0) -> UIColor {
		...
		let str = String(ar[0]).lowercased()
		if let c = cssColorList[str] { return c }

		if let fc = str.unicodeScalars.first, CharacterSet.letters.contains(fc) { // fast?
			if let cv = cssNames[str] { v = cv }
		}
